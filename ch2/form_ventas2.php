...
<div class="row"> 
	<div class="col-lg-4 col-lg-offset-4 col-xs-12">
		<form action="ventas2.php" method="POST" enctype="multipart/form-data" > 
			 <center><table border="1">
            </center></table>
		  <div class="form-group">
            <label for="text">Cantidad de producto:</label>
            ...
            <?php
            include("con.php");
            $result=sqlsrv_query($conn, "SELECT * FROM PRODUCTO WHERE EXISTENCIA > '0'");
